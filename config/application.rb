...
module ResourceMap
  class Application < Rails::Application
    ...
    config.assets.precompile += %w( jquery.mobile-1.3.1.min.css jquery.js jquery_ujs.js knockout-2.2.1.js custom_bindings/mobileenable.js mobile/mobilecache.js mobile/collections.js mobile/events.js  )
