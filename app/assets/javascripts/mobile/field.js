...
Field.prototype.getSelectOneField = function() {
  ...
  for(var i=0; i< this.options.length; i++){
    list = list + "<option value='" + this.options[i]["code"] + "' >" + this.options[i]["name"] + "</option>" ;
  }
      ...
      '<div class="ui-checkbox">' +         
          '<label for="checkbox-1a" data-theme="c" class="ui-btn ui-btn-icon-left ui-corner-all ui-btn-up-c"  style="margin:0px;">' +
            '<span class="ui-btn-inner ui-corner-top">'+
              ...
              '<input type="checkbox" value="' + this.options[i]["code"] + '" name="properties[' + this.id + '][]" id="' + this.options[i]["code"] + '" class="custom">' +
            '</span>'+
          '</label>'+
      '</div>';
  }
